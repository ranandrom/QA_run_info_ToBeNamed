...
/**
 * Description:
 * <br/>Function: This class is main class.
 * <br/>File Name: QA_run_info.java
 * <br/>Date: 2017-03-30
	...
	public static void main(String[] args) throws InterruptedException
    {
		...
		for (int len = 0; len < args_len; len+=2) {
			if( args[len].equals("-P") || args[len].equals("-p") ){
				...
				System.out.println("-P or -p\t Set operation path. The default value is \"/Src_Data1/analysis/Ironman/\".");
				System.out.println("-C or -c\t Set Whether cover old file. Inuput 0 or 1, 0 representative overwrite file data and 1 additional file data. The default value is 1.");
				System.out.println("-O or -o\t Set output file. The default value is \"./Ironman\".");
				System.out.println("-U or -u\t Set Whether upload file to wdmycloud. Inuput 0 or 1, 1 representative upload file and 0 is not. The default value is 1.");
				System.out.println("-F or -f\t Set file upload pattern(all file or partial file). Inuput 0 or 1, 0 representative upload all file and 1 upload partial file. The default value is 0.");
				System.out.println("-L or -l\t Set Upload file path. The default value is \"/wdmycloud/anchordx_cloud/杨莹莹/项目-生信-汇总表/\".");
				System.out.println();
				return;
			} else {
				System.out.println();
